...
export function debugEnvironment() {
    ...
    import('./config.js').then(({ CONFIG }) => {
        ...
        const usingCORSProxy = CONFIG.API_URLS.gaza.includes('codetabs.com') || CONFIG.API_URLS.gaza.includes('cors.sh') || CONFIG.API_URLS.gaza.includes('corsproxy.io') || CONFIG.API_URLS.gaza.includes('allorigins.win');
